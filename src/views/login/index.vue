<template>
  <div class="container-login">
    <el-card class="my-card">
      <img src="../../assets//assets/logo_index.png" alt />
      ...
      <el-form ref="loginForm" :model="loginForm" :rules="loginRules" status-icon>
        ...
        <el-form-item>
          <el-checkbox :value="true" >我已阅读和同意协议条款</el-checkbox>
        </el-form-item>
         <el-form-item>
...
export default {
  data () {
    ...
    const checkMobile = (rule, value, callback) => {
      // 校验逻辑:1 开头  第二位 3-9 之间 最后 9个数字结尾
...
.container-login {
  ...
  left: 0;
  top: 0;
  background: url("../../assets/assets/login_bg.jpg") no-repeat center / cover;
  .my-card {
    width: 400px;
    height: 350px;
    position: absolute;
